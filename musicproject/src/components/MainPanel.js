  ...
  return (<>
    <div id="MainPanel">
      ...
      <LoginButton setLoginScreen={setLoginScreen} loginScreen={loginScreen} 
        logged={props.logged} setLogged={props.setLogged}/>
    </div>
      <Modal successScreen={successScreen} setSuccessScreen={setSuccessScreen} setLogged={props.setLogged} logged={props.logged} setLoginScreen={setLoginScreen} loginScreen={loginScreen}/>
